...
```bash
nono run --allow-cwd --secrets openai_api_key -- my-agent
```
...
```bash
# Load single secret
nono run --allow-cwd --secrets openai_api_key -- claude

# Load multiple secrets
nono run --allow-cwd --secrets openai_api_key,anthropic_api_key -- claude
```
...
```bash
nono run --allow-cwd --secrets openai_api_key --dry-run -- my-agent
```
